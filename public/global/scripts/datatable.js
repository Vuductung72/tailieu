...
var Datatable = function() {
    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "language": { // language settings
                        ...
                        "metronicAjaxRequestGeneralError": "Không thể lấy được dữ liệu. Vui lòng kiểm tra kết nối internet",
            ...
            tableContainer.on('keydown', 'input.form-filter:not([type="radio"],[type="checkbox"])', function(e) {
                if (e.keyCode === 13) {
                    e.preventDefault();
                    the.submitFilter();
                }
