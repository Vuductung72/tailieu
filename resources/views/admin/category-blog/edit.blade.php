...
@section('page_title', 'Sửa danh mục bài viết')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form action="{{ route('ad.category-blog.update', $category_blog) }}" method="POST" @submit.prevent="onSubmit" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Nhập tên danh mục bài viết...." v-validate="'required'" data-vv-as="&quot;Tên&quot;" value="{{ old('name', $category_blog->name) }}">
                                    ...
                                    <div>
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px;">
                                                <img class="img-responsive" src="{{ asset($category_blog->image) }}" alt="" />
                                            </div>
