...
@section('page_title', 'Danh sách danh mục bài viết')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light portlet-datatable bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{ route('ad.category-blog.create') }}" class="btn btn-circle btn-sm btn-primary"> <i class="fa fa-plus"></i> Thêm mới</a>
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="admin-table">
                        ...
                        <tbody>
                            @foreach ($category_blog as $key => $category)
                            <tr>
                                <td >{{ $key+1 }}</td>
                                <td >{{ $category->name}}</td>
                                <td >{{ $category->slug}}</td>
                                ...
                                <td >
                                    ...
                                    <a class="btn btn-circle btn-sm btn-warning" href="{{ route('ad.category-blog.edit', $category->id) }}"><i class="fa fa-pencil"></i></a>
                    ...
                    <div class="text-center">
                        {{ $category_blog->withQueryString()->links('web.layouts.paginate') }}
                    </div>
                </div>
            </div>
        </div>
