...
@section('page_title', 'Sửa danh mục tài liệu')
@section('content')
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                    <label for="name">Tên danh mục tài liệu<span class="required">*</span></label>
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Nhập tên danh mục tài liệu...." v-validate="'required'" data-vv-as="&quot;Tên&quot;" value="{{ old('name', $category->name) }}">
                                    ...
                                    <div>
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px;">
                                                <img class="img-responsive" src="{{ asset($category->image) }}" alt="" />
                                            </div>
